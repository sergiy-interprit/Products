...
namespace Products.Services.Interfaces
{
    public interface IAccountService
    {
        ...
        Task<Account> GetAccountById(int id, bool includeProducts);  // TODO: Remove later
        ...
        Task UpdateAccount(Account accountToBeUpdated, Account account); // TODO: Remove later
